...
namespace drawing {
	...
	public:
		constexpr Text(ImFont* font, const ImVec2& pos, ImU32 color, const std::string& text, bool dropShadow, bool centered, bool outline)
			: m_font{ font }, m_pos{ pos }, m_color{ color }, m_text{ text }, m_dropShadow{ dropShadow }, m_centred{ centered }, m_outline{ outline }
		{
		}
	...
	public:
		constexpr TextSize(float fontSize, ImFont* font, const ImVec2& pos, ImU32 color, const std::string& text, bool dropShadow, bool centered, bool outline)
			: m_size{ fontSize }, m_font{ font }, m_pos{ pos }, m_color{ color }, m_text{ text }, m_dropShadow{ dropShadow }, m_centred{ centered }, m_outline{ outline }
		{
		}
